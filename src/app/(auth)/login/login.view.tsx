...
interface LoginViewProps {
  onEmailLogin: (formData: FormData) => Promise<void>;
  onGoogleLogin: () => Promise<{ url: string }>;
  error?: string;
}

export function LoginView({ onEmailLogin, onGoogleLogin, error }: LoginViewProps) {
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <Link
              ...
              className="text-xs text-brand hover:text-brand-glow transition-colors"
            >
              Forgot password?
            </Link>
          </div>
